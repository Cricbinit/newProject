...
function ResposiveAppBar() {
  ...
  return (
    <AppBar position="static" sx={{ height: "120px", display: "flex", justifyContent: "center", alignItems: "center" }} style={{ background: "#2e4053" }}>
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }} >
                <Avatar alt="profile" src={Image1} sx={{ width: 100, height: 100 }} />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
